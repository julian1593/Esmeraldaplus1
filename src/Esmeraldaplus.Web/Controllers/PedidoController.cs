...
namespace Esmeraldaplus.Web.Controllers
{
    public class PedidoController : Controller
    {
        ...
        {
            var esmeraldaplusDbContext = _context.Pedido.Include(p => p.IdProductoNavigation).Include(p => p.IdVendedorNavigation);
        ...
        public async Task<IActionResult> Create([Bind("IdPedido,FechaPedido,FechaEntrega,IdProducto,IdVendedor")] Pedido pedido)
        {
            ...
            ViewData["IdVendedor"] = new SelectList(_context.Vendedor, "IdVendedor", "IdVendedor", pedido.IdVendedor);
            return View(pedido);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdPedido,FechaPedido,FechaEntrega,IdProducto,IdVendedor")] Pedido pedido)
        {
